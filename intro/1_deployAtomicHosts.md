...
for VM in atomic-master atomic-host-01 atomic-host-02 atomic-host-03 atomic-host-04; do
  ...
  # get the MAC address of the new VM and set up static IPs so the rest is magic
